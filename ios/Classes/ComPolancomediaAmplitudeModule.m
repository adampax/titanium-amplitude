 ...
 */
#import "ComPolancomediaAmplitudeModule.h"
#import "TiBase.h"
#import "TiHost.h"
#import "TiUtils.h"

@implementation ComPolancomediaAmplitudeModule
...
-(id)moduleGUID
{
	return @"ccd4ad76-162c-41a2-ad01-0be35ccf7edc";
}

// this is generated for your module, please do not change it
-(NSString*)moduleId
{
	return @"com.polancomedia.amplitude";
}
...
-(void)initialize:(id)args
{
    ...
    [Amplitude initializeApiKey:args];
}

-(void)setUserId:(id)args
{
    ENSURE_SINGLE_ARG(args, NSString);
    [Amplitude setUserId:args];
}
